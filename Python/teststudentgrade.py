...
class TestStudentGrade(TestCase):
	...
	def test_get_best_and_worst_student_exists(self):
		self.assertIsNotNone(studentgrade.get_best_and_worst_student(self.student_scores))
		
	def test_get_best_and_worst_student(self):
